...
public class LoginServlet extends HttpServlet {
	...
	@Override
	protected void doPost(ttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
...
//		
//		out.printf("<button type='button' onclick='history.back()'> 돌아가기 </button>", result);		
//		
//		out.println("</body>");
//		
//		out.println("</html>");
		...
		// - HttpServletResquest, HttpServletResponse를 매개변수로 전달
